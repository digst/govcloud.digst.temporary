 ...
 */
package raw.data.borgerdk.avro;  
@SuppressWarnings("all")
@org.apache.avro.specific.AvroGenerated
public class Mapping extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Mapping\",\"namespace\":\"raw.data.borgerdk.avro\",\"fields\":[{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"url\",\"type\":\"string\"},{\"name\":\"referrer\",\"type\":\"string\"},{\"name\":\"useragent\",\"type\":\"string\"},{\"name\":\"sessionid\",\"type\":[\"null\",\"int\"],\"default\":null}]}");
   ...
   */
  public Mapping(java.lang.CharSequence ip, java.lang.Long timestamp, java.lang.CharSequence url, java.lang.CharSequence referrer, java.lang.CharSequence useragent, java.lang.Integer sessionid) {
    this.ip = ip;
  ...
  /** Creates a new Mapping RecordBuilder */
  public static raw.data.borgerdk.avro.Mapping.Builder newBuilder() {
    return new raw.data.borgerdk.avro.Mapping.Builder();
  }
  
  /** Creates a new Mapping RecordBuilder by copying an existing Builder */
  public static raw.data.borgerdk.avro.Mapping.Builder newBuilder(raw.data.borgerdk.avro.Mapping.Builder other) {
    return new raw.data.borgerdk.avro.Mapping.Builder(other);
  }
  
  /** Creates a new Mapping RecordBuilder by copying an existing Mapping instance */
  public static raw.data.borgerdk.avro.Mapping.Builder newBuilder(raw.data.borgerdk.avro.Mapping other) {
    return new raw.data.borgerdk.avro.Mapping.Builder(other);
  }
  
  /**
   * RecordBuilder for Mapping instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Mapping>
    implements org.apache.avro.data.RecordBuilder<Mapping> {
    ...
    private Builder() {
      super(raw.data.borgerdk.avro.Mapping.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(raw.data.borgerdk.avro.Mapping.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Mapping instance */
    private Builder(raw.data.borgerdk.avro.Mapping other) {
            super(raw.data.borgerdk.avro.Mapping.SCHEMA$);
      if (isValidValue(fields()[0], other.ip)) {
        this.ip = data().deepCopy(fields()[0].schema(), other.ip);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'ip' field */
    public raw.data.borgerdk.avro.Mapping.Builder setIp(java.lang.CharSequence value) {
    ...
    public raw.data.borgerdk.avro.Mapping.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'timestamp' field */
    public raw.data.borgerdk.avro.Mapping.Builder setTimestamp(long value) {
    ...
    public raw.data.borgerdk.avro.Mapping.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'url' field */
    public raw.data.borgerdk.avro.Mapping.Builder setUrl(java.lang.CharSequence value) {
    ...
    public raw.data.borgerdk.avro.Mapping.Builder clearUrl() {
      url = null;
    ...
    /** Sets the value of the 'referrer' field */
    public raw.data.borgerdk.avro.Mapping.Builder setReferrer(java.lang.CharSequence value) {
    ...
    public raw.data.borgerdk.avro.Mapping.Builder clearReferrer() {
      referrer = null;
    ...
    /** Sets the value of the 'useragent' field */
    public raw.data.borgerdk.avro.Mapping.Builder setUseragent(java.lang.CharSequence value) {
    ...
    public raw.data.borgerdk.avro.Mapping.Builder clearUseragent() {
      useragent = null;
    ...
    /** Sets the value of the 'sessionid' field */
    public raw.data.borgerdk.avro.Mapping.Builder setSessionid(java.lang.Integer value) {
    ...
    public raw.data.borgerdk.avro.Mapping.Builder clearSessionid() {
      sessionid = null;
